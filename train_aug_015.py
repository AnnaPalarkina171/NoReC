...
print(f'THIS IS SIMPLE NORBERT MODEL using data with 3 augmented classes: 0, 1 and 5. Augmentstion was made using NoRBert')
print(f'LR = {LR}, dropout= {DROPOUT}, num_warmup_steps= {WARMUP}')

df_0 = pd.read_csv('augmented_splited_0_5_norbert.csv')
df_1 = pd.read_csv('augmented_splited_1_5_norbert.csv')
df_5 = pd.read_csv('augmented_splited_5_5_norbert.csv')
