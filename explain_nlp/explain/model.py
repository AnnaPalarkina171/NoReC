...
class ExplainableModel(nn.Module):
    def __init__(self):
        super().__init__()
        self.bert_config = BertConfig.from_pretrained('ltgoslo/norbert2', output_hidden_states=False)
        self.intermediate = BertModel.from_pretrained('ltgoslo/norbert2')
        ...
        self.output = nn.Linear(self.bert_config.hidden_size, 6)#self.bert_config.num_labels)
