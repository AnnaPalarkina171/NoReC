...
#import sys 
#sys.path.append('/Users/annapalatkina/Desktop/Self_Explaining_Structures_Improve_NLP_Models/datasets')
...
from datasets.norec_dataset import NoReCDataset
...
class ExplainNLP(nn.Module):
    ...
    def configure_optimizers(self):
        ...
        MAX_EPOCHS = 10
        t_total = len(self.train_dataloader()) // self.args.accumulate_grad_batches * MAX_EPOCHS
...
def get_parser():
    ...
    parser.add_argument("--save_path", default='outputs/', type=str, help="path to save checkpoints")
